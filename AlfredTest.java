public class AlfredTest {
    ...
    */
    public static void main(String[] args) {
        ...
        String testGreeting = alfredBot.guestGreeting();
        String testGuestGreeting = alfredBot.guestGreeting("Beth Kane");
        String testGuestGreeting2 = alfredBot.guestGreeting("Beth Kinn", "mañana");
        ...
        String broma = alfredBot.responderConMolestia("No me ayudas para nada alfred, quizá ya deberías ser cambiado.");
